...
export function buildPasswordResetHtml(input: PasswordResetTemplateInput): string {
  const { appName, recipientName, resetUrl, expiresInMinutes } = input;
          ...
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:560px;background:#ffffff;border:1px solid #e5e7eb;">
            ...
            <tr>
              <td style="padding:16px 28px;font-size:15px;line-height:1.6;font-family:Arial,Helvetica,sans-serif;color:#333333;">
                ...
                <br /><br />
                We received a request to reset your password. This link expires in ${String(expiresInMinutes)} minutes.
                If you did not request this, you can ignore this email.
              </td>
            </tr>
            <tr>
              <td style="padding:8px 28px 28px;font-family:Arial,Helvetica,sans-serif;">
                <a href="${escapeHtml(resetUrl)}" style="display:inline-block;background:#1f3a2e;color:#ffffff;text-decoration:none;padding:12px 20px;font-size:14px;">
                  Reset password
                </a>
              </td>
            </tr>
...
export function buildPasswordResetText(input: PasswordResetTemplateInput): string {
  return [
    `Hi ${input.recipientName},`,
    '',
    `Reset your password for ${input.appName}.`,
