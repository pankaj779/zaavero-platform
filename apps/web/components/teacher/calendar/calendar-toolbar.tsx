...
export type CalendarPortalMode = 'teacher' | 'student';
...
export function CalendarToolbar({
  ...
  pageCopy?: Partial<typeof teacherCalendarPageCopy>;
}): React.JSX.Element {
  const copy = { ...teacherCalendarPageCopy, ...pageCopy };
  const showTeacherActions = portalMode === 'teacher';
        ...
        <>
          <div className="flex flex-wrap gap-2">
            <Button
              ...
              size="sm"
              disabled
              aria-label={`${copy.createEventButton} — coming soon`}
            >
            ...
            <Button
              ...
              size="sm"
              disabled
              aria-label={`${copy.syncButton} — coming soon`}
            >
              {copy.syncButton}
            </Button>
            <Button
